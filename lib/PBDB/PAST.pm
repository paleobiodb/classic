...
EOF
    ...
    if (! -e $filename) {
        print "You must do a <a href=\"classic?action=displayDownloadForm\">download</a> before you can use these functions.\n";
    } else	{
        print "You may want to do another <a href=\"classic?action=displayDownloadForm\">download</a> before using these functions.\n";
    }
...
sub getDownloadFileName {
    ...
    my $base_filename = PBDB::PBDBUtil::getFilename($name);
