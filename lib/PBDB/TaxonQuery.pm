...
sub fetchSingle {
	...
	"SELECT a.taxon_no, a.taxon_rank, a.taxon_name, a.common_name, a.extant, o.status, o.spelling_reason,
		pa.taxon_no as parent_no, pa.taxon_name as parent_name, t.spelling_no, t.synonym_no, a.orig_no,
...
# this function is disabled by the removal of proprietary code written by
#  JA (see below)
...
sub calculateFirstAppearance {
    ...
    # disabled because intervalData is proprietary code that did not belong
    #  in this  module JA 5.6.13
    ...
    # following section was removed because it was copied from a proprietary
    #  section of TaxonInfo.pm that does not belong with the PaleoDB
    #  JA 5.6.13
    # AGE RANGE/CONFIDENCE INTERVAL CALCULATION

    # Now construct the output record.
    # this orphan fragment is left in because it was written by McClennen
    #  JA 5.6.13
