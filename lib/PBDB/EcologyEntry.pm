...
sub populateEcologyForm	{
	...
	if ( $ecotaph->{'reference_no'} )	{
		...
		push @values , '<center><div class="small" style="width: 60em; text-align: left; text-indent: -1em;">Primary reference: ' . PBDB::Reference::formatLongRef(${$dbt->getData($sql)}[0]) . '</div></center>';
